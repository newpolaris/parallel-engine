...
public class COLLADA {
    ...
    @XmlType(name = "", propOrder = {
        ...
        "instanceVisualScene",
        "instanceKinematicsScenes",
        "extras"
    })
    public static class Scene {

        @XmlElement(name = "instance_physics_scene")
        protected List<InstanceWithExtraType> instancePhysicsScenes;
        ...
        protected List<InstanceKinematicsSceneType> instanceKinematicsScenes;
        @XmlElement(name = "extra")
        protected List<ExtraType> extras;
         ...
         * 
         */
        public List<InstanceWithExtraType> getInstancePhysicsScenes() {
            if (instancePhysicsScenes == null) {
                instancePhysicsScenes = new ArrayList<InstanceWithExtraType>();
            }
        ...
        /**
         * Gets the value of the instanceKinematicsScenes property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the instanceKinematicsScenes property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getInstanceKinematicsScenes().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<InstanceKinematicsSceneType> getInstanceKinematicsScenes() {
            if (instanceKinematicsScenes == null) {
                instanceKinematicsScenes = new ArrayList<InstanceKinematicsSceneType>();
            }
            return this.instanceKinematicsScenes;
        }
