...
public class GlslProgramType {
    ...
    protected List<GlslShaderType> shaders;
    @XmlElement(name = "bind_attribute")
    protected List<GlslProgramType.BindAttribute> bindAttributes;
    @XmlElement(name = "bind_uniform")
    protected List<GlslProgramType.BindUniform> bindUniforms;
     ...
     * 
     */
    public List<GlslShaderType> getShaders() {
        if (shaders == null) {
            shaders = new ArrayList<GlslShaderType>();
        }
        return this.shaders;
    }
     ...
     * 
     */
    public List<GlslProgramType.BindAttribute> getBindAttributes() {
        if (bindAttributes == null) {
            bindAttributes = new ArrayList<GlslProgramType.BindAttribute>();
        }
     ...
     * 
     */
    public List<GlslProgramType.BindUniform> getBindUniforms() {
        if (bindUniforms == null) {
            bindUniforms = new ArrayList<GlslProgramType.BindUniform>();
        }
