...
public class InstanceRigidBodyType {
    ...
    public static class TechniqueCommon {
        ...
        protected List<InstanceRigidBodyType.TechniqueCommon.Shape> shapes;
         ...
         * 
         */
        public List<InstanceRigidBodyType.TechniqueCommon.Shape> getShapes() {
            if (shapes == null) {
                shapes = new ArrayList<InstanceRigidBodyType.TechniqueCommon.Shape>();
            }
            return this.shapes;
        }
