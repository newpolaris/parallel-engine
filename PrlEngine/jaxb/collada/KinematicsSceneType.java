...
public class KinematicsSceneType {
    ...
    protected List<InstanceArticulatedSystemType> instanceArticulatedSystems;
    ...
    /**
     * Gets the value of the instanceArticulatedSystems property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the instanceArticulatedSystems property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInstanceArticulatedSystems().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InstanceArticulatedSystemType> getInstanceArticulatedSystems() {
        if (instanceArticulatedSystems == null) {
            instanceArticulatedSystems = new ArrayList<InstanceArticulatedSystemType>();
        }
        return this.instanceArticulatedSystems;
    }
