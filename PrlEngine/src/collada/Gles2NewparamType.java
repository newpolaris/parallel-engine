...
@XmlSeeAlso({
    collada.ProfileGles2Type.Newparam.class
})
public class Gles2NewparamType {
    ...
    public static class Array {
        ...
        protected List<JAXBElement<?>> boolsAndBvec2SAndBvec3S;
        @XmlAttribute(required = true)
        @XmlSchemaType(name = "positiveInteger")
        protected BigInteger length;

        /**
         * Gets the value of the boolsAndBvec2SAndBvec3S property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the boolsAndBvec2SAndBvec3S property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getBoolsAndBvec2sAndBvec3s().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<JAXBElement<?>> getBoolsAndBvec2sAndBvec3s() {
            if (boolsAndBvec2SAndBvec3S == null) {
                boolsAndBvec2SAndBvec3S = new ArrayList<JAXBElement<?>>();
            }
            return this.boolsAndBvec2SAndBvec3S;
        }
    ...
    public static class Usertype {
        ...
        protected List<Gles2NewparamType.Usertype.Setparam> setparams;
        @XmlAttribute(required = true)
        @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
         ...
         * 
         */
        public List<Gles2NewparamType.Usertype.Setparam> getSetparams() {
            if (setparams == null) {
                setparams = new ArrayList<Gles2NewparamType.Usertype.Setparam>();
            }
