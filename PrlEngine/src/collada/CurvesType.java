 ...
 * 			
 * 
 * <p>Java class for curves_type complex type.
 * 
...
@XmlType(name = "curves_type", propOrder = {
    "curves",
    "extras"
})
public class CurvesType {

    @XmlElement(name = "curve", required = true)
    protected List<CurveType> curves;
     ...
     * 
     */
    public List<CurveType> getCurves() {
        if (curves == null) {
            curves = new ArrayList<CurveType>();
        }
        return this.curves;
    }
