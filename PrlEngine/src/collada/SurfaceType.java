...
public class SurfaceType {
    ...
    protected List<OrientType> orients;
    ...
    /**
     * Gets the value of the orients property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the orients property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOrients().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OrientType> getOrients() {
        if (orients == null) {
            orients = new ArrayList<OrientType>();
        }
        return this.orients;
    }
