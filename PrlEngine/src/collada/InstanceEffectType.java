...
public class InstanceEffectType {
    ...
    protected List<InstanceEffectType.TechniqueHint> techniqueHints;
    @XmlElement(name = "setparam")
    protected List<InstanceEffectType.Setparam> setparams;
     ...
     * 
     */
    public List<InstanceEffectType.TechniqueHint> getTechniqueHints() {
        if (techniqueHints == null) {
            techniqueHints = new ArrayList<InstanceEffectType.TechniqueHint>();
        }
     ...
     * 
     */
    public List<InstanceEffectType.Setparam> getSetparams() {
        if (setparams == null) {
            setparams = new ArrayList<InstanceEffectType.Setparam>();
        }
