...
public class LibraryPhysicsMaterialsType {
    ...
    protected List<PhysicsMaterialType> physicsMaterials;
     ...
     * 
     */
    public List<PhysicsMaterialType> getPhysicsMaterials() {
        if (physicsMaterials == null) {
            physicsMaterials = new ArrayList<PhysicsMaterialType>();
        }
