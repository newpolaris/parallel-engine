...
public class RigidBodyType {
    ...
    public static class TechniqueCommon {
        ...
        protected List<RigidBodyType.TechniqueCommon.Shape> shapes;
         ...
         * 
         */
        public List<RigidBodyType.TechniqueCommon.Shape> getShapes() {
            if (shapes == null) {
                shapes = new ArrayList<RigidBodyType.TechniqueCommon.Shape>();
            }
            return this.shapes;
        }
